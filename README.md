...
I have created here two server. one is for apiserver(back-end server) and another one for uiserver(front-end server). I am calling the API's in the client side using jquery ajax.
